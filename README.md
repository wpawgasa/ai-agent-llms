...
| **E4B on corpus v3** | `model/sft-gemma4-e4b-c2-on-task-a-v3` | `checkpoints/sft_cat_a_e4b/gemma-4-E4B-it` (stage `task_a_sft_gemma4_e4b`) | Gemma-4-E4B-it LoRA, C2 recipe on `corpus/task-a-v3`, 82 files / 1.70 GB, best checkpoint-3168. Phase 1 benchmark 0.6678 — see [the result](docs/cat_a_e4b_sft_benchmark_result.md). |
